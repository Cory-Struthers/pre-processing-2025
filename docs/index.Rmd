...
knitr::opts_knit$set(root.dir = "~/Library/CloudStorage/Box-Box/A_teaching/POL290G_TextAsData/modules/data/")
```
...
news_data <- read_xlsx("~/Library/CloudStorage/Box-Box/A_teaching/POL290G_TextAsData/modules/data/sample_news_1995-2017.xlsx") 
...
4. Repeat Step 3 but making different (yet still rational) pre-processing decisions toward the _same_ research goal, again explaining your decisions.
